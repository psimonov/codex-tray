...
- تحديثات فورية للحصة عبر إشعارات `account/rateLimits/updated`، مع التحقق عند تمرير المؤشر إذا كانت البيانات قديمة.
...
- إظهار اللوحة على الشاشة التي تحتوي على الأيقونة عند تمرير المؤشر وإخفاؤها عند ابتعاده.
...
- مرّر المؤشر فوق الأيقونة لإظهار لوحة الحصة على الشاشة نفسها.
...
تصل تحديثات الحصة عبر اتصال دائم واحد مع `codex app-server`. يقرأ Codex Tray الحساب والحدود مرة واحدة عند بدء الاتصال، ويحفظ الإشعارات الجزئية اللاحقة ويدمجها تكرارياً، ثم يعيد الاتصال إذا توقف app-server بصورة غير متوقعة. يكرر التحديث الصريح الطلبين. إذا عُرضت اللوحة وكان عمر اللقطة 30 ثانية على الأقل، يطابقها Codex Tray مرة واحدة عبر `account/rateLimits/read`؛ ولا يجري استطلاعاً دورياً في الخلفية.
