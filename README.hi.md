...
कोटा अपडेट `codex app-server` के साथ एक स्थायी connection से आते हैं। Codex Tray शुरुआत में account और limits को एक बार पढ़ता है, दोनों requests को केवल स्पष्ट refresh के बाद दोहराता है, बाद की आंशिक सूचनाओं को मिलाता है और app-server के अनपेक्षित रूप से बंद होने पर फिर से जुड़ता है।
