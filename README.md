...
4. Move the executable to any permanent folder and run it.
...
Codex Tray has no configuration file or environment variables. The optional Windows startup entry is controlled from the tray context menu and always uses the dynamically detected path of the running executable.
